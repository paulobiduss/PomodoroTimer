...
class AppSettings:
    ...
    def __init__(self):
        ...
        self._focus_history = FocusHistory(self._store)
        self._focus_history.migrate_legacy_today()
    ...
    def increment_session(self, focus_duration_minutes: int):
        self.record_focus_session(focus_duration_minutes)

    @property
    def focus_history(self) -> FocusHistory:
        return self._focus_history

    def record_focus_session(self, focus_duration_minutes: int):
        self._focus_history.add_focus_minutes(focus_duration_minutes)
